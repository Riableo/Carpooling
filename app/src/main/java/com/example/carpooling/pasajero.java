...
public class pasajero extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        from=(EditText)findViewById(R.id.Origen);
        to=(EditText)findViewById(R.id.destino);
    ...
    public void init2(){
        miurl="http://10.0.2.2/carpool/Consultar.php?Origen="+from.getText().toString()+"&Destino="+to.getText().toString();
    ...
    public void mostrar() {
        ...
        lista.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            {//Al hacer click en cualquiera de los elementos de la lista
                Intent ir=new Intent(pasajero.this, end.class);
                ir.putExtra("Nombre", name.getText());
                ir.putExtra("Origen",var2);
                ir.putExtra("Destino",var3);
                startActivity(ir);
            }
        });
    }
